"""Library-level SqFtProForma tests (relocated from urbansim/developer/tests/).

Tests config defaults, cost range sanity, monotonicity, max_dua constraint,
and detailed feasibility decomposition — coverage not duplicated in
test_proforma_developer.py.
"""
import os
...
from urbansim.developer import sqftproforma as sqpf
