"""Library-level Developer tests (relocated from urbansim/developer/tests/).

Tests compute_units_to_build(), keep_form_with_max_profit(), merge(),
and pick() with form-keyed feasibility dict — coverage not duplicated
in test_proforma_developer.py.
"""
import pandas as pd
import pytest
